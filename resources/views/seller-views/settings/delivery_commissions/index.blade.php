                ...
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    @endphp
                        ...
                        <tr class="class-all">
                            ...
                            <td>{{$get_brand ? $get_brand->name : ''}} {{$order->name}}</td>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label for="exampleInputPassword1" class="form-label">تاريخ البداية</label>

                                                <input type="date" name="commissions_start_date" class="form-control" id="exampleInputPassword1">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="commissions_end_date" class="form-control" id="exampleInputPassword1">
